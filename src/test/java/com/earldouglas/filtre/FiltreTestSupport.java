...
public abstract class FiltreTestSupport {
	...
	protected void filtreWebTest(String compositeAllowList,
			String compositeDenyList, String configLocation, boolean accessible)
			throws Exception {
		...
		if (compositeAllowList != null) {
			filterHolder.setInitParameter("allowList", compositeAllowList);
		}
		if (compositeDenyList != null) {
			filterHolder.setInitParameter("denyList", compositeDenyList);
		}
