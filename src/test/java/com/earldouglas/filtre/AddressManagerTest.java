...
public class AddressManagerTest {
	...
	private void testAddressManager(String address, String compositeAllowList,
			String compositeDenyList, String configLocation, boolean accessible)
			throws Exception {

		AddressManager addressManager = new AddressManager();
		addressManager.extendAllowList(compositeAllowList);
		addressManager.extendDenyList(compositeDenyList);
